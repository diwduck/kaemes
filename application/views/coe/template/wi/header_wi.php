...
<head>
  ...
  <title>SIMAPAN SDM | BPSDMD Jateng</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/datepicker/datepicker.css'); ?>" rel="stylesheet" type="text/css" />
  <!-- DataTables -->
  ...
  <!-- Toggle -->
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/bootstrap-toggle/css/bootstrap4-toggle.css'); ?>" type="text/css"/>
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/bootstrap-toggle/css/bootstrap4-toggle.min.css'); ?>" type="text/css"/>
