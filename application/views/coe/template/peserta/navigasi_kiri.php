            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        // Jika yang login dikfung
                        elseif ($jenis_diklat == 'Diklat Fungsional') {
                            ?>
                            <li class="nav-item ">
                                <a href="<?= site_url('peserta/dikfung/Dikfung') ?>" class="nav-link <?= active_menu('Diknis') ?>">
                                    <i class="nav-icon fas fa-columns"></i>
                                    <p>Home</p>
                                </a>
                            </li>
                        ...
                        // Jika yang login diknis
                        elseif ($jenis_diklat == 'Diklat Teknis') {
                            ?>
                            <li class="nav-item ">
                                <a href="<?= site_url('peserta/diiknis/Diknis') ?>" class="nav-link <?= active_menu('Diknis') ?>">
                                    <i class="nav-icon fas fa-columns"></i>
                                    <p>Home</p>
                                </a>
                            </li>
                        ...
                        ?>
                        <!--                        <li class="nav-item">
                                                    <a href="<?= site_url('peserta/Profil') ?>" class="nav-link <?= active_menu('Profil') ?>">
                        ...
                        <?php
                        if ($status_judul == "Diterima" AND $status_latar == "Diterima" AND $status_manfaat == "Diterima" AND $status_milestone == "Diterima" AND $status_file_ra == "Diterima" AND $status_file_la == "Diterima" AND $final == "1") {
                            ?>
