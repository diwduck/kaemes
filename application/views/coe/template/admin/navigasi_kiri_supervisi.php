            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-child-indent nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item ">
                            <a href="<?= site_url('admin/Dashboard') ?>" class="nav-link <?= active_menu('Dashboard') ?>">
                        ...
                        <li class="nav-item treeview <?= ($menu == "5" || $menu == "6") ? 'menu-open' : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= site_url('admin/Diklat') ?>" class="nav-link <?= ($menu == "5") ? 'active' : '' ?>">
                                ...
                                <?php
                                    ...
                                    { ?>
                                        <li class="nav-item">
                                            <a href="<?= site_url('admin/Peserta') ?>" class="nav-link  <?= ($menu == "6") ? 'active' : '' ?>">
