                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                <input id="id_pelatihan" type="hidden" value="<?= htmlspecialchars($id_pelatihan); ?>">
                            </h3>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; vertical-align: middle;">
                                                    ...
                                                    if ($item['file_ra'] == NULL) {
                                                        ...
                                                        ?>
                                                        <a href="<?= base_url('assets/inovasi/ra/' . htmlspecialchars($item['file_ra'])); ?>" target=blank_>
                                                ...
                                                <td style="text-align: center; vertical-align: middle;">
                                                    ...
                                                    if ($item['file_proper'] == NULL) {
                                                        ...
                                                        ?>
                                                        <a href="<?= base_url('assets/inovasi/la/' . htmlspecialchars($item['file_proper'])); ?>" target=blank_>
                                                ...
                                                <td style="text-align: center; vertical-align: middle;">
                                                    <?= htmlspecialchars(date_format(date_create($item['timestamp']), "d-m-Y | H:i")); ?>
                                                </td>

                                                <td style="text-align: center; vertical-align: middle;">
                                                    <!--Tombol lihat detail data peserta-->
                                                    <a href="javascript: void(0)" onclick="show_detail(<?= htmlspecialchars($item['id_diklat']); ?>, '<?= htmlspecialchars($item['NIP']); ?>')" data-toggle="modal" data-target="#show-detail-peserta" title="Lihat detail" class="btn btn-xs btn-primary">
                                                        <i class="fas fa-info-circle"></i>
                                                    </a>

                                                    <!--Tombol upload file RA peserta-->
                                                    <?php
                                                    if ($item['file_ra'] == NULL) {
                                                        ?>
                                                        <a href="javascript: void(0)" onclick="show_modal_upload_ra(<?= htmlspecialchars($item['id_proper']); ?>)" data-toggle="modal" data-target="#show-upload-ra" title="Upload File RA" class="btn btn-xs btn-success">
                                                            <i class="fas fa-upload"></i>
                                                        </a>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <a href="javascript: void(0)" onclick="show_modal_upload_ra(<?= htmlspecialchars($item['id_proper']); ?>)" data-toggle="modal" data-target="#show-upload-ra" title="Upload Ulang File RA" class="btn btn-xs btn-warning">
                                                            <i class="fas fa-upload"></i>
                                                        </a>
                                                    <?php } ?>

                                                    <!--Tombol upload file proper peserta-->
                                                    <?php
                                                    if ($item['file_proper'] == NULL) {
                                                        ?>
                                                        <a href="javascript: void(0)" onclick="show_modal_upload(<?= htmlspecialchars($item['id_proper']); ?>)" data-toggle="modal" data-target="#show-upload-proper" title="Upload File Proper" class="btn btn-xs btn-success">
                                                            <i class="fas fa-upload"></i>
                                                        </a>
                                                        <?php
                                                    } else {
                                                        ?>
                                                        <a href="javascript: void(0)" onclick="show_modal_upload(<?= htmlspecialchars($item['id_proper']); ?>)" data-toggle="modal" data-target="#show-upload-proper" title="Upload Ulang File Proper" class="btn btn-xs btn-warning">
                                                            <i class="fas fa-upload"></i>
                                                        </a>
                                                    <?php } ?>

                                                    <!--Tombol hapus data peserta-->
                                                    <a href="<?= site_url('admin/Diklat/hapus_peserta_pelatihan/?id_proper=' . htmlspecialchars($item['id_proper']).'&id_diklat=' . htmlspecialchars($id_diklat)) ?>" onclick="return confirm('Yakin ingin menghapus Peserta <?= $item['nama'] ?> dari Pelatihan ini? Semua data Proper yang diajukan juga akan ikut terhapus.');" title="Hapus Peserta dari Pelatihan ini" class="btn btn-xs btn-danger">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <label>Coach</label>
                        <!--Tombol ubah atau ganti coach-->
                        <a href="javascript:void(0)" title="Ganti Coach" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#modal-ganti-coach">
                            <b><i class="fas fa-pen"></i> Ganti Coach</b>
                        </a>
                        <p id="profilcoach"></p>
                    </div>
                </div>
                                                    ...
                                                    <table id="datatable1" class="table table-bordered table-hover">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th style="color:#007bff;text-align: center;">Action</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;" id="konseling_aksilatarbelakang"></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;" id="konseling_aksijudul"></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;" id="konseling_aksimanfaat"></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;" id="konseling_aksimilestone"></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;" id="konseling_aksi_ra"></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;" id="konseling_aksi_la"></td>
                                                            </tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: center;" id="konseling_aksi_abstraksi"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form class="form-horizontal" method="post" action="<?php echo site_url('admin/Diklat/update_abstrak_peserta/'); ?>">
                ...
                <div class="card-body pad">
                    <div class="mb-3">
                        <textarea name="abstraksi" rows="10" readonly class="textareaajuan" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><div id="konseling_abstraksi"></div></textarea>
...
<div class="modal fade" id="modal-ganti-coach">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" style="color:red;">Ganti Coach</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form role="form" enctype="multipart/form-data" action="<?= site_url('admin/Diklat/ganti_coach_admin/'); ?>" method="POST">
                <div class="card-body pad">
                    <div class="form-group">
                        <label>Pilih Nama Coach</label>
                        <select onchange="onchange_ajax_nama_coach()" id="id_coach" name="id_coach" class="form-control select2" style="width: 100%;" required>
                          <option disabled selected>--Pilih Nama Coach Baru--</option>
                            <?php
                            foreach ($pakwi as $item) {
                                ?>
                                          <option value="<?= htmlspecialchars($item->nip); ?>"><?= htmlspecialchars($item->nama); ?></option>
                            <?php }
                            ?>
                        </select>
                    </div>

                    <input id="nip_ganti_coach" value="" name="nip" hidden readonly>
                    <input id="id_diklat_ganti_coach" value="" name="id_diklat" hidden readonly>
                    <input id="jenis_diklat_ganti_coach" value="" name="jenis_diklat" hidden readonly>
                    <input id="nama_diklat_ganti_coach" value="" name="nama_diklat" hidden readonly>
                    <input name="nama_coach" id="nama_coach" hidden readonly>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    <button type="submit" name="simpan" value="1" class="btn btn-success">Simpan</a>
                </div>
            </form>
        </div>
        <!-- /.modal-content -->
...
<!--show modal upload file proper ======================================================================================================-->
<div class="modal fade" id="show-upload-proper">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" style="color:red;">Upload file Proper</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form role="form" enctype="multipart/form-data" action="<?= site_url('admin/Diklat/upload_proper_admin/'); ?>" method="POST">
                <div class="card-body pad">
                    <div class="form-group">
                        <label>Pilih File Proper</label>
                        <input onchange="return validasiFile()" required id="file_proper" style="padding: 3px;" type="file" class="form-control" name="file_upload_proper" required>
                    </div>

                    <input id="id_proper_upload" value="" name="id_proper_upload" hidden>
                    <input id="id_diklat_upload" value="<?= htmlspecialchars($id_diklat); ?>" name="id_diklat_upload" hidden>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    <button type="submit" name="simpan" value="1" class="btn btn-success">Simpan</a>
...
<!--show modal upload file RA ======================================================================================================-->
<div class="modal fade" id="show-upload-ra">
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" style="color:red;">Upload file RA</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form role="form" enctype="multipart/form-data" action="<?= site_url('admin/Diklat/upload_ra_dikpim_admin/'); ?>" method="POST">
                <div class="card-body pad">
                    <div class="form-group">
                        <label>Pilih File RA</label>
                        <input onchange="return validasiFile_dikpim_ra()" required id="file_ra" style="padding: 3px;" type="file" class="form-control" name="file_upload_ra" required>
                    </div>

                    <input id="id_proper_upload_ra" value="" name="id_proper_upload" hidden>
                    <input id="id_diklat_upload_ra" value="<?= htmlspecialchars($id_diklat); ?>" name="id_diklat_upload" hidden>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
                    <button type="submit" name="simpan" value="1" class="btn btn-success">Simpan</a>
...
<script type="text/javascript">
    ...
    function show_detail(id_diklat, nip)
    {
        ...
        $.ajax({
            ...
            success: function (respData) {
                ...
                $('#konseling_aksijudul').html(cData.aksi_judul);
                ...
                $('#konseling_aksilatarbelakang').html(cData.aksi_latar);
                ...
                $('#konseling_aksimanfaat').html(cData.aksi_manfaat);
                ...
                $('#konseling_aksi_ra').html(cData.aksi_ra);
                ...
                $('#konseling_aksi_la').html(cData.aksi_la);
                $('#konseling_aksi_abstraksi').html(cData.aksi_abstraksi);
                $('#ubahabstraknip').val(cData.nip);
            }
        });
    }

    //sweet alert for setujui diklat
    function konfirmasi_setujui(id, topik, jenis_diklat)
    {
        Swal.fire({
            title: 'Apakah anda yakin ingin mengubah status pada topik ini menjadi disetujui?',
            icon: 'warning',
    ...
    //sweet alert for revisi diklat
    function konfirmasi_revisi(id, topik, jenis_diklat)
    {
        Swal.fire({
            title: 'Apakah anda yakin ingin mengubah status pada topik ini menjadi direvisi?',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
    ...
    //sweet alert for convert value on database proper become NULL
    function konfirmasi_kosongkan(id, topik, nip)
    {
        Swal.fire({
            title: 'Apakah anda yakin ingin mengosongkan isi pada topik ini?',
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
    ...
    //function ajax for konfirmasi setujui
    function setujui_ajax(id_proper, topik)
    {
        $.ajax({
            type: 'POST',
            url: '../konfirmasi_setujui',
            data: 'id=' + id_proper + '&topik=' + topik,
    ...
    //function ajax for konfirmasi revisi
    function revisi_ajax(id_proper, topik)
    {
        $.ajax({
            type: 'POST',
            url: '../konfirmasi_revisi',
            data: 'id=' + id_proper + '&topik=' + topik,
            success: function (returndata) {
                pesan_berhasil();
            }
    ...
    //function ajax for konfirmasi kosongkan
    function kosongkan_ajax(id_proper, topik, nip)
    {
        $.ajax({
            type: 'POST',
            url: '../konfirmasi_kosongkan',
            data: 'id=' + id_proper + '&topik=' + topik + '&nip=' + nip,
            success: function (returndata) {
                pesan_berhasil();
            }
        });
    ...
    //Function alert notification for success
    function pesan_berhasil()
    {
        Swal.fire('Ubah status berhasil',
    ...
    //function ajax onchange nama coach
    function onchange_ajax_nama_coach()
    {
        var id_coach = document.getElementById("id_coach").value;

        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>index.php/peserta/DashboardPeserta/get_nama_coach',
            dataType: 'json',
            data: {id_coach: id_coach},
            cache: false,
            success: function (result) {
                $("#nama_coach").val(result["nama_coach"]);
            }
        });
    }

    //fungsi untuk menampilkan modal detail peserta
    function show_modal_upload(id_proper)
    {
        $('#show-upload-proper').modal('show'); //buka modal
        $('#id_proper_upload').val(id_proper);
    }

    //fungsi untuk menampilkan modal detail peserta
    function show_modal_upload_ra(id_proper)
    {
        $('#show-upload-ra').modal('show'); //buka modal
        $('#id_proper_upload_ra').val(id_proper);
    }
