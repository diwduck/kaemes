                                        ...
                                        foreach ($listMasterDiklat as $item) {
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; vertical-align: middle;">
                                                    ...
                                                    if ($item['juklak'] != NULL) 
                                                    { ?>
                                                        <a style="color: white;" href="<?= base_url('assets/file/' . $item['juklak']) ?>" target="_blank">
                                              ...
                                              <?php } ?>
                                                ...
                                                <td style="text-align: center; vertical-align: middle;">
                                                    ...
                                                    if ($item['jadwal'] != NULL) 
                                                    { ?>
                                                        <a style="color: white;" href="<?= base_url('assets/file/' . $item['jadwal']) ?>" target="_blank">
                                                            <button type="button" class="btn btn-primary">
                                                                <i class="fas fa-eye"></i>
                                                            </button>
                                                        </a>
                                              <?php } ?>
                                                ...
                                                <td style="text-align: center; vertical-align: middle;">
                                                    <a style="color: white;" href="<?= site_url('admin/Diklat/materi/' . $item['id_diklat']); ?>">
                                                        <button type="button" class="btn btn-primary">
                                                            <i class="fas fa-eye"></i>
                                                        </button>
                                                    </a>
